/* Native simulation of the player open-loop motion timeline.
 ...
 * do, so the feedforward spin-up/down and pitch behaviour can be checked
 * without hardware. Speed is open-loop; there is no runtime feedback loop.
 *
